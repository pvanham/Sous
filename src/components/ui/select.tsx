...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      // Base styles
      "flex h-9 w-full items-center justify-between whitespace-nowrap rounded px-3 py-2 text-sm",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "focus:bg-stone-100 dark:focus:bg-stone-800 focus:text-accent-foreground",
