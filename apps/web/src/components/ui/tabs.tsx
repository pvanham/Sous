...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-center rounded p-1 text-muted-foreground",
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-card dark:data-[state=active]:bg-stone-900",
      "data-[state=active]:text-stone-900 dark:data-[state=active]:text-stone-100",
      className,
    )}
    {...props}
  />
